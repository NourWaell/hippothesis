        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, get_payload_1.getPayloadClient)({
                        initOptions: {
                            express: app,
                            onInit: function (cms) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, cms.logger.info("Admin URL: ".concat(cms.getAdminURL()))];
                            }); }); },
                        },
                    })];
            case 1:
                ...
                if (process.env.NEXT_BUILD) {
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    payload.logger.info("Next.js app is building...");
                                    // @ts-expect-error
                ...
                next_utils_1.nextApp.prepare().then(function () {
                    payload.logger.info("Server started on port ".concat(PORT));
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
