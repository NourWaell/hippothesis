          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order ws processed and your assets are available to
                download below. We&apos;ve also sent your receipt and other
                details to{" "}
              ...
              <p className="mt-2 text-base text-muted-foreground">
                ...
                it. So hang tight and we&apos;ll send you a confirmation email
                very soon!
              </p>
            )}
