...
const perks = [
  ...
  },
  {
    name: "For The Planet",
    icon: Leaf,
    description: "We've pledged 1% of sales to the preservation of our planet.",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to Hippothesis. Every asset on our platform is verified by
            ...
            {perks.map((perk) => (
              ...
              >
                <div className="md:flex-shrink-0 flex justify-center">
                  <div className="h-16 w-16 flex items-center justify-center rounded-full bg-blue-100 text-blue-700">
